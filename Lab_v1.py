...
class HandOverSimulator:
    def __init__(self):
        ...
        self.Target_Angle_Value = 40
        self.Cur_Angle_Value = 40
        self.Cur_RSRP_Value = self.CaseDataBehind['Case'][str(self.Cur_Angle_Value)]['Angle'][str(self.Cur_Angle_Value)]
        self.Cur_Case_Value = 40
        self.Old_Case_Value = 40
        ...
        # 暫時使用的變數
        self.Counter = 0
        self.Input_RSRP_Value = 0
        self.Input_Angle_Value = 0
    ...
    def Start(self):
        ...
        # 啟動更新數值的執行緒
        self.update_state_thread = threading.Thread(target=self.Updata_State)
    ...
    def Updata_State(self):
        while self.running:
            ...
            self.Cur_RSRP_Value = self.Input_RSRP_Value 
            # RSRP 的偏差
    ...
    def Input(self, Cur_RSRP_Value, Cur_Angle_Value):
        self.Input_RSRP_Value = Cur_RSRP_Value
        self.Input_Angle_Value = Cur_Angle_Value
        self.Cur_Angle_Value = Cur_Angle_Value

    def Output(self):
        return self.Cur_Case_Value, self.Target_Angle_Value
